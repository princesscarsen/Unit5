...
public class LinkedPriorityQueue implements PriorityQueue{
    ...
    public void enqueue(Object obj){
        throw new IllegalStateException("Please Enter ALL Data");
    }
    ...
    public Object dequeue() {
        if(list[0].isEmpty()){
            if(list[1].isEmpty()){
                if(list[2].isEmpty()){
                    throw new IllegalStateException("Everyone has been Treated");
                }
    ...
    public Object peekFront() {
        if(list[0].isEmpty()){
            if(list[1].isEmpty()){
                if(list[2].isEmpty()){
                    throw new IllegalStateException("All patients are treated");
                }
